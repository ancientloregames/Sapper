...
class InputManager {
    ...
    public int getSelectY() {return selectY;}
    public int getSelectX() {return selectX;}
    public GameButton getFlagButton() {return flagButton;}
    public GameButton getMenuButton() {return menuButton;}
    public void switchFlagButton(){
        if (flagButtonActive)flagButton.setBitmap(flagBitmapInactive);
        else flagButton.setBitmap(flagBitmapActive);
